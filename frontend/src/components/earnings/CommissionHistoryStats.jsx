...
export default function CommissionHistoryStats({ t }) {
  const stats = [
    {
    ...
    {
      title: t('earnings.history.stats.thisMonth'),
      value: "₹ 12,350.00",
    ...
    {
      title: t('earnings.history.stats.totalTransactions'),
      value: "128",
      subtitle: t('earnings.stats.totalSub'),
    ...
    {
      title: t('earnings.history.stats.pendingCommission'),
      value: "₹ 8,450.00",
