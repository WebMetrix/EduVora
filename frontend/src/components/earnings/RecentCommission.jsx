        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-slate-100">
              <th className="pb-4 text-[13px] font-extrabold text-slate-600 uppercase tracking-wider whitespace-nowrap">{t('earnings.table.date')}</th>
              <th className="pb-4 text-[13px] font-extrabold text-slate-600 uppercase tracking-wider whitespace-nowrap">{t('earnings.table.type')}</th>
              <th className="pb-4 text-[13px] font-extrabold text-slate-600 uppercase tracking-wider whitespace-nowrap">{t('earnings.table.level')}</th>
              <th className="pb-4 text-[13px] font-extrabold text-slate-600 uppercase tracking-wider whitespace-nowrap">{t('earnings.table.from')}</th>
              <th className="pb-4 text-[13px] font-extrabold text-slate-600 uppercase tracking-wider whitespace-nowrap">{t('earnings.table.amount')}</th>
              <th className="pb-4 text-[13px] font-extrabold text-slate-600 uppercase tracking-wider whitespace-nowrap">{t('earnings.table.status')}</th>
            </tr>
          </thead>
          <tbody>
            {tableData.map((row) => (
              <tr key={row.id} className="group border-b last:border-b-0 border-indigo-100/30 hover:bg-slate-50/50 hover:shadow-sm hover:-translate-y-0.5 relative transition-all duration-300 cursor-pointer">
                <td className="py-4 text-[13px] font-extrabold text-[#1a1446] group-hover:text-[#4f3bf3] transition-colors whitespace-nowrap">{row.date}</td>
                <td className="py-4 text-[13px] font-bold text-slate-700 whitespace-nowrap">{row.type}</td>
                <td className="py-4 text-[12px] font-semibold text-slate-600 whitespace-nowrap">{row.level}</td>
                <td className="py-4 text-[12px] font-semibold text-slate-600 whitespace-nowrap">{row.from}</td>
                <td className="py-4 text-[13px] font-extrabold text-[#1a1446] whitespace-nowrap">{row.amount}</td>
