...
export default function KycDocumentUploadForm({ onNext, onPrev }) {
      ...
      <div className="grid grid-cols-1 2xl:grid-cols-2 gap-6 mb-8">
        ...
        <div className="border border-slate-100 rounded-2xl p-6 shadow-sm flex flex-col">
          ...
          <div className="bg-[#f8f9fe] rounded-xl p-4 flex gap-3 items-start mb-6">
            ...
            <div>
              <p className="text-[13px] text-slate-800 font-medium mb-1">Please upload clear front and back side of your {docType}.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <div className="border border-dashed border-indigo-200 rounded-2xl p-5 flex flex-col items-center justify-center text-center bg-white hover:bg-[#f8f9fe] transition-colors cursor-pointer min-h-[160px]">
                ...
                <p className="text-[12px] text-slate-500 font-medium mb-3">Drag & drop front side image here<br/><span className="text-slate-400 mt-1 block">or</span></p>
                <button className="px-5 py-2 border border-indigo-200 text-[#4f3bf3] rounded-xl text-[13px] font-bold bg-white hover:bg-indigo-50 transition-colors">
                  Choose File
                </button>
              </div>
            </div>
            <div>
              ...
              <div className="border border-dashed border-indigo-200 rounded-2xl p-5 flex flex-col items-center justify-center text-center bg-white hover:bg-[#f8f9fe] transition-colors cursor-pointer min-h-[160px]">
                <UploadCloud className="w-6 h-6 text-[#4f3bf3] mb-3" />
                <p className="text-[12px] text-slate-500 font-medium mb-3">Drag & drop back side image here<br/><span className="text-slate-400 mt-1 block">or</span></p>
                <button className="px-5 py-2 border border-indigo-200 text-[#4f3bf3] rounded-xl text-[13px] font-bold bg-white hover:bg-indigo-50 transition-colors">
                  Choose File
                </button>
              </div>
        ...
        <div className="border border-slate-100 rounded-2xl p-6 shadow-sm flex flex-col">
          ...
          <div className="mb-6">
            ...
            <div className="border border-dashed border-indigo-200 rounded-2xl p-8 flex flex-col items-center justify-center text-center bg-white hover:bg-[#f8f9fe] transition-colors cursor-pointer min-h-[220px]">
              ...
              <p className="text-[13px] text-slate-500 font-medium mb-4">Drag & drop front side image here<br/><span className="text-slate-400 mt-2 block text-[12px]">or</span></p>
              <button className="px-5 py-2 border border-indigo-200 text-[#4f3bf3] rounded-xl text-[13px] font-bold bg-white hover:bg-indigo-50 transition-colors">
                Choose File
              </button>
            </div>
