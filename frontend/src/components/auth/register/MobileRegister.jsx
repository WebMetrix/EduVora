  ...
  return (
    <div className="w-full min-h-screen flex flex-col relative pb-safe pt-safe bg-white md:hidden overflow-x-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 z-10 w-full pb-10">
        ...
        <div className="w-full max-w-[360px] mx-auto flex-grow flex flex-col justify-center">
          ...
          <div className="relative flex items-center py-4 mb-4">
            ...
            <span className="flex-shrink-0 mx-4 text-slate-400 text-[13px] font-medium">{t('register.orSignUpWith')}</span>
            <div className="flex-grow border-t border-slate-200/80"></div>
          </div>
